...
export default function FilterSearch() {
  ...
  const location = ['New York', 'Los Angeles', 'Chicago', 'Houston', 'Phoenix'];
  const type = ['Hotel', 'Apartment', 'Villa', 'Resort', 'Hostel'];

  return (
    <div className=" flex  justify-center p-4">
      {/* Desktop Layout */}
      <div className="hidden xl:flex absolute -bottom-20   left-10 right-10">
      ...
      {/* Tablet Layout */}
      <div className="hidden absolute -bottom-48 md:block xl:hidden w-full max-w-3xl">
        <div className="bg-white backdrop-blur-sm shadow-2xl rounded-2xl border border-white/20 p-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Box className="flex items-center border border-/20 rounded-lg px-3 py-2 flex-1 justify-between">
                <Button
                  onClick={() => setCount(prev => Math.max(prev - 1, 1))}
                  size="small"
      ...
      {/* Mobile Layout */}
      <div className="block md:hidden absolute -bottom-72 w-full max-w-sm">
