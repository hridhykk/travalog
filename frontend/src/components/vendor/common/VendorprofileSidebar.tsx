...
export const SidebarNav = () => {
  ...
  const menuItems = [
    { label: 'Profile', icon: <User className="w-5 h-5" />, path: '/vendor/vednorProfile' },
    { label: 'Package Details', icon: <Building2 className="w-5 h-5" />, path: '/vendor/packagedetails' },
    { label: 'Upload Contents', icon: <Upload className="w-5 h-5" />, path: '/vendor/uploadcontent' },
    { label: 'Bookings', icon: <Calendar className="w-5 h-5" />, path: '/vendor/bookings' },
